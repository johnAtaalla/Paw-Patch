...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div class="header">
        <div>
          <h2 class="our-desc">Pet Aid Contacts</h2> 
        </div>
      </div>
     <br>
     <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-xl-10 col-lg-10 col-md-10" id="med-desc" style="border:1px solid black; min-height:515px;">
  ...
  <div class="card">
    <div class="card-body">
      <div class="table-responsive">
        <table class="table table-bordered table-striped desc-font">
          <thead>
            <tr>
              <th>Name</th>
              <th>Email</th>
          ...
          <tbody>
            <?php while($row = $result->fetch_assoc()) { ?>
              <tr>
                <td class ="table-font"><?php echo $row["firstname"] . " " . $row["lastname"]; ?></td>
                <td><?php echo $row["email"]; ?></td>
                <td><?php echo $row["phone"]; ?></td>
                <td><?php echo $row["cert"]; ?></td>
                <td><?php echo $row["yearsP"]; ?></td>
              </tr>
            <?php } ?>
          </tbody>
        </table>
